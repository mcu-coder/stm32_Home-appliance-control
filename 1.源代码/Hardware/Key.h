...
#define KEY1	GPIO_ReadInputDataBit(KEY_PROT, KEY1_GPIO_PIN) // 读取按键0
#define KEY2	GPIO_ReadInputDataBit(KEY_PROT, KEY2_GPIO_PIN) // 读取按键1
#define KEY3	GPIO_ReadInputDataBit(KEY_PROT, KEY3_GPIO_PIN) // 读取按键2
